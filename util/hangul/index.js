...
hook.decompose = decompose = function(str) {
    var decomp = [];
    str.split('').forEach(e => {
...
hook.english_to_hangul = function(str) {
    ...
    for (var i = 0; i < str.length; i++) {
        ...
        // jungseong
        var jung;
        var temp_jung = (i+2) > str.length ? undefined : eng_jungseong[str.substr(i, 2)];
        ...
        // jongseong
        var jong;
        var temp_jong = (i+2) > str.length ? undefined : eng_jongseong[str.substr(i, 2)];
        if (temp_jong !== undefined)  {
            jong = temp_jong;
            temp_jung = ((i+2)+1) > str.length ? undefined : eng_jungseong[str.substr(i+2, 1)];
            if (temp_jung !== undefined) {
            ...
            temp_jung = ((i+1)+1) > str.length ? undefined : eng_jungseong[str.substr(i+1, 1)];
            if (temp_jung !== undefined) {
                jong = 0;
                i--;
            }
