...
class Elasticsearch {
    ...
    * */
    ...
    insertDocs(indexName, reqQuery){
        let param = {
            index: indexName,
            body: reqQuery
        }
        return this.elasticClient.index(param)
    };

    updateDocs(indexName, reqQuery, docId){
        let param = {
            index: indexName,
            id: docId,
            body: {
        ...
        //console.log(param);
        return this.elasticClient.update(param)
    };

    deleteDocs(indexName, docId){
        let param = {
            index: indexName,
            id: docId,
        }
        //console.log(param);
        return this.elasticClient.delete(param)
    };
    /*
